...
namespace GSMA.MobileConnect.Demo.Universal
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private Discovery.OperatorUrls _urls;
        ...
        {
            var response = await _mobileConnect.HandleUrlRedirectAsync(url, _state, _nonce, _urls?.RequestTokenUrl);
        ...
        private async Task StartAuthorization(MobileConnectStatus response)
        {
            ...
            _urls = response.DiscoveryResponse.OperatorUrls;
            var newResponse = _mobileConnect.StartAuthorization(_urls.AuthorizationUrl,
